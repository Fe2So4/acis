  ...
  router = new Router({
    routes: [
      ...
      },
      {
        ...
        name: 'PrintDocument1',
        component: () => import('@/views/PrintDocument1/index')
      },
      {
      ...
      {
        path: '/printDocumentPDF/:templateId/:operationId/:patientId/:pageIndex/:isRescueMode/:opePhase/:pageInfo/:flag/:totalPageNum',
