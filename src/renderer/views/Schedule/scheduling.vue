<template>
  <div class="schedule">
    <div class="schedule-left">
      <div class="option">
        <el-row>
          ...
          <el-col :span="11">
            <el-select v-model="type" placeholder="楼层" style="width:100%">
              <el-option value="6" />
              <el-option value="7" />
              <el-option value="8" />
            </el-select>
    ...
    <div class="schedule-right">
      <div class="right-content" @contextmenu="showMenu7">
        <div class="switch-detail" v-show="!showSwitch">
          <div class="current-room">
            <div class="floor-number">
              <div ref="title">手术间{{ currentId }}</div>
            </div>
          ...
          <div class="detail" ref="detail" @contextmenu.prevent="clearContextMenu">
            <Detail :detail="detail" />
          </div>
          <div class="all-room">
            <Room :room-list="roomList" @changeRoom="changeRoom" />
          </div>
          <div class="submit">
            <el-button type="primary" @click="preview" size="mini">提交前预览</el-button>
            <el-button size="mini" type="primary" @click="submitAll">提交</el-button>
            <!-- <el-button type="primary" @click="getCurrentTime">重置</el-button> -->
          </div>
        </div>
        <div class="switch-all" v-show="showSwitch">
      ...
      <!-- 撤回区域-->
      <div class="withdraw">
        <with-draw :records-list="recordsList" @handleWithdraw="handleWithdraw" />
      </div>
    </div>
