      ...
      >
        ...
        >
          ...
          <div class="patient-detail">
            申请时间：<span>{{ patientBasBasicInfo.opeScheduleTime }}</span> 病区：<span>{{ patientBasBasicInfo.inpatientWard }}</span> 床位: <span>{{ patientBasBasicInfo.bedId }}</span> 住院号：<span>{{ patientBasBasicInfo.visitId }}</span> 医师：<span>{{ patientBasBasicInfo.surgeon }}</span>
            手术：<span>{{ patientBasBasicInfo.operation }}</span> 病人姓名：<span>{{ patientBasBasicInfo.ptName }}</span> 诊断：<span>{{ patientBasBasicInfo.diagnose }}</span> 备注：<span>{{ patientBasBasicInfo.diagnose }}</span>
          </div>
          <div class="room">
            <Room
              :time="this.timeDate"
