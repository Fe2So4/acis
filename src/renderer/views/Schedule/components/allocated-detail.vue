...
import { getDetailDocList, getDetailNurseList, getAnaesMethod, updateSimpleApply } from '@/api/schedule'
...
<style lang="scss" scoped>
  .detail{
   ...
   .allocated-detail{
    ...
    //     width:400px;
    // }
    .allocated-detail /deep/ .el-select .el-select-dropdown,.el-select-dropdown .content{
        display:flex;
    ...
    .allocated-detail /deep/ .el-select .el-select-dropdown,.el-select-dropdown .el-select-dropdown__item{
        padding:0;
        width:400px;
    }
    .allocated-detail /deep/ .el-select .el-select-dropdown,.el-select-dropdown .el-select-dropdown__item.is-disabled{
        background:#f3f6f9;
        cursor: auto;
        color:#000;
    }
