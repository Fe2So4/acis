    ...
    >
      <div class="detail">
          ...
          <el-row type="flex" justify="space-between">
            <el-col :span="10">
              <el-form-item label="手术医师">
                <el-input v-model="detailApply.surgeonName" disabled />
              </el-form-item>
            </el-col>
            <el-col :span="10">
              <el-form-item label="麻醉方法">
                <el-select
                  v-model="detailApply.anesMethod"
                  placeholder="请选择"
                  filterable
                >
                  <!-- @change="changeValue" -->
          ...
          <el-row type="flex" justify="space-between">
            ...
            <el-col :span="10">
              <el-form-item label="副麻1">
                <el-select
                  v-model="detailApply.firstAnesDocId"
                  placeholder="请选择"
                  filterable
                >
                  <!-- @change="changeValue" -->
          ...
          <el-row type="flex" justify="space-between">
            ...
            <el-col :span="10">
              ...
              @selectOperaion="selectOperaion(4)"
                />-->
                <el-select
                  v-model="detailApply.thirdAnesDocId"
                  placeholder="请选择"
                  filterable
                >
                  <!-- @change="changeValue" -->
        ...
        <div class="option" style="display: flex; justify-content: center">
          <el-button type="primary" @click="updateSimpleApply" size="mini">
            确定
          </el-button>
