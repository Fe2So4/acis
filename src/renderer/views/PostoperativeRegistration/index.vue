      ...
      el-row
        el-col(:span="6")
          el-form-item(label="出生日期")
            el-date-picker(v-model="form.ptId" type="date" value-format="yyyy-MM-dd" format="yyyy-MM-dd")
        el-col(:span="6")
          el-form-item(label="床号")
            el-input(v-model="form.ptId")
        el-col(:span="12")
          el-form-item(label="所在科室")
            el-select(v-model="form.ptId" placeholder="请选择所在科室")
              el-option(
      ...
      el-row
        el-col(:span="24")
          el-form-item(label="主要诊断")
            el-select(v-model="form.ptId" placeholder="请选择诊断")
              el-option(
                v-for="item in options"
                :key="item.value"
                :label="item.label"
      ...
      el-row
        ...
        el-col(:span="12")
          el-form-item(label="手术间" prop="room")
            el-select(v-model="form.room" placeholder="请选择手术间" )
              el-option(
                v-for="item in options"
                :key="item.value"
                :label="item.label"
      ...
      el-row
        el-col(:span="6")
          el-form-item(label="隔离")
            el-select(v-model="form.ptId" placeholder="请选择是否隔离")
              el-option(
                v-for="item in isolation"
                :key="item.value"
                :label="item.label"
                :value="item.value")
        el-col(:span="6")
          el-form-item(label="等级")
            el-select(v-model="form.ptId" placeholder="请选择等级")
              el-option(
                v-for="item in level"
                :key="item.value"
                :label="item.label"
      ...
      el-row
        el-col(:span="6")
          el-form-item(label="手术医师")
            el-select(v-model="form.ptId" placeholder="请选择手术间")
              el-option(
                v-for="item in options"
                :key="item.value"
                :label="item.label"
      ...
      el-row
        el-col(:span="5")
          el-form-item(label="护士换班")
            <el-radio-group v-model="form.ptId">
              <el-radio :label="3">未换班</el-radio>
              <el-radio :label="6">换班</el-radio>
            </el-radio-group>
        el-col(:span="9")
          el-form-item(label="麻醉满意度")
            <el-radio-group v-model="form.ptId">
              <el-radio :label="3">满意</el-radio>
              <el-radio :label="6">不全满意</el-radio>
              <el-radio :label="9">改麻醉</el-radio>
            </el-radio-group>
        el-col(:span="5")
          el-form-item(label="手术过程顺利")
            <el-radio-group v-model="form.ptId">
              <el-radio :label="3">顺利</el-radio>
              <el-radio :label="6">不顺利</el-radio>
            </el-radio-group>
        el-col(:span="5")
          el-form-item(label="器械清点")
            <el-radio-group v-model="form.ptId">
              <el-radio :label="3">对数</el-radio>
              <el-radio :label="6">不对数</el-radio>
            </el-radio-group>
      el-row
        el-col(:span="5")
