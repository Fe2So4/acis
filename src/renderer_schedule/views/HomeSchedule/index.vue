  ...
  <div class="common-layout-container">
    ...
    >
      <div class="unlock-container">
        <div class="logo-box">
          <img
            src="src/common/assets/tongqian.png"
            alt=""
          >
        </div>
        <el-form :inline="true">
...
import { debounce } from 'src/common/utils/index'
// import { login } from '../../api/login'
import { getCurrentAccount } from 'src/common/utils/storage'
...
.el-dialog__wrapper {
  ...
  /deep/ .lock-dialog {
    height: 420px;
    background: url('~src/common/assets/lock_bg.png') no-repeat center;
    box-shadow: none;
  }
